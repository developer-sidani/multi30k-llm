...
python together_llms.py \
  ...
  --path_tgt_test "data/multi30k/data/task1/raw/test_2016_flickr.cs" \
  --path_test_ref "data/multi30k/data/task1/raw/cs/2016_flickr" \
  --n_references 1 \
  ...
  --path_tgt_examples "data/multi30k/data/task1/raw/train.cs"
