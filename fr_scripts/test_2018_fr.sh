...
python together_llms.py \
  --src_lang "English" \
  --tgt_lang "French" \
  --path_src_test "data/multi30k/data/task1/raw/test_2018_flickr.en" \
  --path_tgt_test "data/multi30k/data/task1/raw/test_2018_flickr.fr" \
  --path_test_ref "data/multi30k/data/task1/raw/fr/2018_flickr" \
  --n_references 1 \
