...
python together_llms.py \
  --src_lang "English" \
  --tgt_lang "French" \
  --path_src_test "data/multi30k/data/task1/raw/test_2017_flickr.en" \
  --path_tgt_test "data/multi30k/data/task1/raw/test_2017_flickr.fr" \
  --path_test_ref "data/multi30k/data/task1/raw/fr/2017_flickr" \
  --n_references 1 \
